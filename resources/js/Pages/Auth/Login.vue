            ...
            <div
                ...
                <form class="space-y-6" action="#">
                    ...
                    <div>
                        ...
                        <FormInput id="email" type="email" name="email" placeholder="asep@example.com" required>
                        </FormInput>
                    </div>
                    <div>
                        <FormLabel for="password">Password</FormLabel>
                        <FormInput id="password" type="password" name="password" placeholder="••••••••" required>
                        </FormInput>
                    </div>
                    ...
                    <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                        Belum punya akun?
                        <Link :href="route('viewRegister')" class="text-blue-700 hover:underline dark:text-blue-500">
                        Buat akun</Link>
                    </div>
                </form>
            </div>
